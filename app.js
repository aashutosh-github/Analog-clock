...
// subtracting the values as it provides some padding to the numbers inside the clock.
const radius = clockBody.offsetWidth / 2 - 55;

const centreX = clockBody.offsetWidth / 2;
const centreY = clockBody.offsetHeight / 2;

numberDivs.forEach((div, index) => {
  // subtracting the 90 because the numbers start from horizontally 0 so subtracting 90 makes the numbers start from the top.
